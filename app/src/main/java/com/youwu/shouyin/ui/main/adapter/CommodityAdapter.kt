 ...
 * @author qdafengzi
 */
class CommodityAdapter(private val mContext: Context, private val mList: List<CommunityBean>?, private var mPosition: Int) : RecyclerView.Adapter<CommodityAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.CommodityName.text = mList!![position].com_name
        holder.CommodityPrice.text = mList!![position].com_price
        holder.CommodityNum.text = "x"+mList!![position].com_number
