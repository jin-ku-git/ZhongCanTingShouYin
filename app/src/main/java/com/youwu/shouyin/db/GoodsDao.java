...
//    private List<CommunityBean.SpecsBean> specs;
    ...
    private final String[] GOODS_COLUMNS = new String[]{"id", "category_id", "image",
            ...
            , "discount", "unit", "cost_price", "ratio_base", "ratio_goods_id", "ratio_unit", "category_name", "store_goods_id", "group_value","goods_type","group_ids", "meals_sku", "meals_num"};
...
//                db.delete(goodsDBHelper.GOODS_TABLE_NAME,"good_id = ?",new String[]{goodBean.getGood_id()});
            ...
            for (int i = 0; i < goodList.size(); i++) {
                ...
                db.update(goodsDBHelper.GOODS_TABLE_NAME, contentValues,
                        "id = ?",
                        new String[]{goodList.get(i).getId()+""});
            }
...
//    }
    ...
    private CommunityBean parseGoodS(Cursor cursor) {
        ...
        goods.setId(cursor.getInt(cursor.getColumnIndex(GOODS_COLUMNS[0])));
