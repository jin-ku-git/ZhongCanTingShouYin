...
//            contentValues.put("ordernumber_bean", MyApplication.gson.toJson(restingInfoBean.getOrderNumberBean()));
//            contentValues.put("vip_bean", MyApplication.gson.toJson(restingInfoBean.getBean()));
//            contentValues.put("shop_car_goods", MyApplication.gson.toJson(restingInfoBean.getShopCarYWGoodBeans()));
...
//        restingInfoBean.setOrderNumberBean(MyApplication.gson.fromJson(cursor.getString(cursor.getColumnIndex(ORDER_COLUMNS[2])), OrderNumberBean.class));
//
//        restingInfoBean.setBean(MyApplication.gson.fromJson(cursor.getString(cursor.getColumnIndex(ORDER_COLUMNS[3])), VIPBean.class));
